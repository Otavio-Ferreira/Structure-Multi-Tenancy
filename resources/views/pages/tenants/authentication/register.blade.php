        ...
        <form action="{{route('login.update', $token_id)}}" method="post" autocomplete="off" novalidate>
          ...
          <div class="mb-3">
            ...
            <div class="input-group input-group-flat">
              <input type="password" class="form-control" name="password" id="password" value="{{old('password')}}" placeholder="Crie uma senha" required>
          ...
          <div class="mb-2">
            ...
            <div class="input-group input-group-flat">
              <input type="password" class="form-control" name="password_confirm" id="password_confirm" value="{{old('password_confirm')}}" placeholder="Confirme a senha" required>
              <span class="input-group-text">
